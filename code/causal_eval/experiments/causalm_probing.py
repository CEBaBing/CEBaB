...
from methods.utils.constants import WANDB_PROJECT, CAUSALM_TASK_LABEL_COL, LABEL_COL, CAUSALM_TC_LABEL_COL
...
def main():
    ...
    if data_args.task_name is not None:
        ...
        label_list = sorted(set(raw_datasets['train'][CAUSALM_TC_LABEL_COL]))
    ...
    if causalm_training_args.do_eval:
        ...
        eval_datasets = {'validation': eval_dataset}
        ...
        for dataset_name, eval_dataset in eval_datasets.items():
            ...
            trainer.log_metrics(dataset_name, metrics)
            trainer.save_metrics(dataset_name, metrics)
