...
from .lstm_vanilla import LSTMConfig

from ..configuration_causalm import CausalmHeadConfig

__all__ = ['LSTMCausalmConfig']


class LSTMCausalmConfig(LSTMConfig):
    """
    Adds a tc_heads and cc_heads parameters to config.
    """
    model_type = "lstm_causalm"
    ...
    def to_diff_dict(self) -> Dict[str, Any]:
        ...
        default_config_dict = LSTMConfig().to_dict()
