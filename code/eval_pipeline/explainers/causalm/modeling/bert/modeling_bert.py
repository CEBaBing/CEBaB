...
from .configuration_bert import BertCausalmConfig
from .supported_heads import SEQUENCE_CLASSIFICATION, TOKEN_CLASSIFICATION, HEAD_TYPES
from .. import CausalmHeadConfig

__all__ = [
    'BertForCausalmAdditionalPreTraining',
    'BertCausalmForSequenceClassification',
    'BertCausalmForTokenClassification',
    'BertForNonlinearSequenceClassification',
...
class BertCausalmForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config: BertCausalmConfig, cf_model: BertModel = None):
        super().__init__(config)
...
class BertCausalmForTokenClassification(BertPreTrainedModel):
    ...
    def __init__(self, config: BertCausalmConfig, cf_model: BertPreTrainedModel):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
        ...
        # assign the adversarially trained model to be the underlying task model and freeze its weights
        if not cf_model:
            raise RuntimeError('Trying to initialize a CausaLM task model without providing counterfactual weights.')
...
class BertCausalmForNonlinearSequenceClassification(BertCausalmForSequenceClassification):
    def __init__(self, config, cf_model=None):
        super(BertCausalmForNonlinearSequenceClassification, self).__init__(config, cf_model)
        self.classifier = BertNonlinearClassificationHead(config)
